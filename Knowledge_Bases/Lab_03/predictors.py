...
class SimplePredictor:
    ...
    def __init__(self, nlp: Language, simplified_type_system: bool = False):
        self.known_types = set()
        self.simplified_type_system = simplified_type_system
        ...
        for after_phrase_tokens in after_phrase_tokens_list:
            ...
            for pos_pattern_len in range(pos_pattern_maxlen, 0, -1):
                for i in range(pos_pattern_len):
                    ...
                    # if self.simplified_type_system:
                    #     lemma_text = tokens[-1].lemma_
                    # else:
    ...
    def train(self, train_filepath: str, load_pos_from_file: bool = True, pos_patterns_number: int = 8):
        ...
        # if self.simplified_type_system:
        #     self.known_types = set([self.lemmatizer.lemmatize(type_words[-1].lower()) for type_words in original_types])
        # else:
